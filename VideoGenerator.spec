...
for pkg in ("customtkinter", "faster_whisper", "ctranslate2", "tokenizers", "onnxruntime", "PIL",
            "requests", "websockets", "yt_dlp", "sounddevice"):
    try:
...
a = Analysis(
    ...
    hiddenimports=hiddenimports + [
        ...
        "editorial.qa",
        "editorial.engine",
        "editorial.shot_planner",
        "editorial.media_analysis",
        "editorial.complements",
        "editorial.edit_decision",
